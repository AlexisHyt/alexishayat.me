...
!function (t, e) {
  ...
  function ck(e) {
    var t,
        ...
        i = b() - C,
        n = !0 === e;
    w < i && (k += i - x), C += i, T.time = (C - k) / 1e3, (0 < (t = T.time - A) || n) && (T.frame++, A += t + (P <= t ? 0.004 : P - t), r = 1), n || (g = v(ck)), r && S.forEach(function (t) {
...
!function (t, e) {
  ...
  function convertToPath(t, e) {
    ...
    return "path" !== T && t.getBBox ? (s = function _createPath(t, e) {
      ...
      for (e = "," + e + ","; -1 < --i;) {
        n = o[i].nodeName.toLowerCase(), e.indexOf("," + n + ",") < 0 && r.setAttributeNS(null, n, o[i].nodeValue);
      }
  ...
  function arcToSegment(t, e, n, r, o, i, a, s, h) {
    if (t !== s || e !== h) {
      ...
      for (I = 0; I < F; I++) {
        P = E(o = Y + I * X), _ = D(o), A = E(o += X), R = D(o), U.push(P - L * _, _ + L * P, A + L * R, R - L * A, A, R);
      }
  ...
  function stringToRawPath(t) {
    ...
    for (e = 0; e < v; e++) {
      if (p = i, isNaN(P[e]) ? a = (i = P[e].toUpperCase()) !== P[e] : e--, r = +P[e + 1], o = +P[e + 2], a && (r += m, o += w), e || (h = r, l = o), "M" === i) s && (s.length < 8 ? --_.length : y += s.length), m = h = r, w = l = o, s = [r, o], _.push(s), e += 2, i = "L";else if ("C" === i) a || (m = w = 0), (s = s || [0, 0]).push(r, o, m + 1 * P[e + 3], w + 1 * P[e + 4], m += 1 * P[e + 5], w += 1 * P[e + 6]), e += 6;else if ("S" === i) c = m, g = w, "C" !== p && "S" !== p || (c += m - s[s.length - 4], g += w - s[s.length - 3]), a || (m = w = 0), s.push(c, g, r, o, m += 1 * P[e + 3], w += 1 * P[e + 4]), e += 4;else if ("Q" === i) c = m + 2 / 3 * (r - m), g = w + 2 / 3 * (o - w), a || (m = w = 0), m += 1 * P[e + 3], w += 1 * P[e + 4], s.push(c, g, m + 2 / 3 * (r - m), w + 2 / 3 * (o - w), m, w), e += 4;else if ("T" === i) c = m - s[s.length - 4], g = w - s[s.length - 3], s.push(m + c, w + g, r + 2 / 3 * (m + 1.5 * c - r), o + 2 / 3 * (w + 1.5 * g - o), m = r, w = o), e += 2;else if ("H" === i) yc(m, w, m = r, w), e += 1;else if ("V" === i) yc(m, w, m, w = r + (a ? w - m : 0)), e += 1;else if ("L" === i || "Z" === i) "Z" === i && (r = h, o = l, s.closed = !0), ("L" === i || 0.5 < k(m - r) || 0.5 < k(w - o)) && (yc(m, w, r, o), "L" === i && (e += 2)), m = r, w = o;else if ("A" === i) {
        if (u = P[e + 4], d = P[e + 5], c = P[e + 6], g = P[e + 7], n = 7, 1 < u.length && (u.length < 3 ? (g = c, c = d, n--) : (g = d, c = u.substr(2), n -= 2), d = u.charAt(1), u = u.charAt(0)), f = arcToSegment(m, w, +P[e + 1], +P[e + 2], +P[e + 3], +u, +d, (a ? m : 0) + 1 * c, (a ? w : 0) + 1 * g), e += n, f) for (n = 0; n < f.length; n++) {
          s.push(f[n]);
        }
  ...
  function Y(t, e, n, r, o) {
    ...
    for (n *= 6, a = 0; a < l; a += 6) {
      h = t[i = (a + n) % g] - (e[a] - r), s = t[1 + i] - (e[a + 1] - o), c += w(s * s + h * h);
    }
  ...
  function Z(t, e, n) {
    ...
    if (n) for (reverseSegment(r = t.slice(0)), i = 6; i < a; i += 6) {
  ...
  function $(t, e, n) {
    for (var r, o, i, a, s, h, l = t.length, c = 1e20, g = 0, f = 0; -1 < --l;) {
      for (h = (r = t[l]).length, s = 0; s < h; s += 6) {
        o = r[s] - e, i = r[s + 1] - n, (a = w(o * o + i * i)) < c && (c = a, g = r[s], f = r[s + 1]);
      }
    }
  ...
  function _(t, e, n, r, o, i) {
    ...
    for (a = n; a < c && !((e[a].size || T(e[a])) < f); a++) {
      s = e[a].centerX - u, h = e[a].centerY - d, (l = w(s * s + h * h)) < p && (g = a, p = l);
    }
  ...
  function aa(t, e) {
    ...
    for (u = 2; u < _; u += 6) {
      for (P += m; 0.999999 < P;) {
        n = t[u - 2], r = t[u - 1], o = t[u], i = t[u + 1], a = t[u + 2], s = t[u + 3], h = t[u + 4], l = t[u + 5], c = n + (o - n) * (d = 1 / ((Math.floor(P) || 1) + 1)), c += ((f = o + (a - o) * d) - c) * d, f += (a + (h - a) * d - f) * d, g = r + (i - r) * d, g += ((p = i + (s - i) * d) - g) * d, p += (s + (l - s) * d - p) * d, t.splice(u, 4, n + (o - n) * d, r + (i - r) * d, c, g, c + (f - c) * d, g + (p - g) * d, f, p, a + (h - a) * d, s + (l - s) * d), u += 6, _ += 6, P--;
      }
    }
  ...
  function ea(t, e) {
    ...
    for (n = 0.5 * e / (0.5 * (o = t.length) - 1), r = 0; r < o - 2; r += 2) {
      if (l += n, s = parseFloat(t[r + 2]), h = parseFloat(t[r + 3]), 0.999999 < l) for (a = 1 / (Math.floor(l) + 1), i = 1; 0.999999 < l;) {
        f += (c + (s - c) * a * i).toFixed(2) + "," + (g + (h - g) * a * i).toFixed(2) + " ", l--, i++;
      }
      f += s + "," + h + " ", c = s, g = h;
    }
  ...
  function ga(e) {
    return isNaN(e) ? fa : function (t) {
      fa(t), t[1] = function _offsetPoints(t, e) {
        ...
        for (n = "reverse" === e ? (r = a - 1, -2) : (r = (2 * (parseInt(e, 10) || 0) + 1 + 100 * a) % a, 2), o = 0; o < a; o += 2) {
          s += i[r - 1] + "," + i[r] + " ", r = (r + n) % a;
        }
  ...
  function ia(t, e) {
    for (var n, r, o, i, a, s, h, l, c, g, f, p, u = t.length, d = 0.2 * (e || 1); -1 < --u;) {
      for (f = (r = t[u]).isSmooth = r.isSmooth || [0, 0, 0, 0], p = r.smoothData = r.smoothData || [0, 0, 0, 0], f.length = 4, l = r.length - 2, h = 6; h < l; h += 6) {
        o = r[h] - r[h - 2], i = r[h + 1] - r[h - 1], a = r[h + 2] - r[h], s = r[h + 3] - r[h + 1], c = v(i, o), g = v(s, a), (n = Math.abs(c - g) < d) && (p[h - 2] = c, p[h + 2] = g, p[h - 1] = w(o * o + i * i), p[h + 3] = w(a * a + s * s)), f.push(n, n, 0, 0, n, n);
      }
  ...
  var o,
    ...
    init: function init(t, e, n, r, o) {
      ...
      if (c = e.shapeIndex || 0 === e.shapeIndex ? e.shapeIndex : "auto", g = e.map || K.defaultMap, this._prop = e.prop, this._render = e.render || K.defaultRender, this._apply = "updateTarget" in e ? e.updateTarget : K.defaultUpdateTarget, this._rnd = Math.pow(10, isNaN(e.precision) ? 2 : +e.precision), this._tween = n, h) {
        if (this._target = t, y = "object" == _typeof(e.precompile), u = this._prop ? t[this._prop] : t.getAttribute(a), this._prop || t.getAttributeNS(null, "data-original") || t.setAttributeNS(null, "data-original", u), "d" === a || this._prop) {
          ...
          for ("log" !== e.precompile && !0 !== e.precompile || M('precompile:["' + rawPathToString(u) + '","' + rawPathToString(d) + '"]'), (S = "linear" !== (e.type || K.defaultType)) && (u = ia(u, e.smoothTolerance), d = ia(d, e.smoothTolerance), u.size || U(u), d.size || U(d), b = ja(C[0]), this._origin = u.origin = {
            ...
            for (w = u[_], v = d[_], f = w.isSmooth || [], p = v.isSmooth || [], m = w.length, P = I = 0; P < m; P += 2) {
              v[P] === w[P] && v[P + 1] === w[P + 1] || (S ? f[P] && p[P] ? (x = w.smoothData, T = v.smoothData, N = P + (P === m - 4 ? 7 - m : 5), this._controlPT = {
    ...
    render: function render(t, e) {
      ...
      if (1 === t && e._apply) for (w = e._pt; w;) {
        w.end && (e._prop ? m[e._prop] = w.end : m.setAttribute(w.endProp, w.end)), w = w._next;
      } else if (u) {
        for (; P;) {
          a = P.sa + t * P.ca, i = P.sl + t * P.cl, P.t[P.i] = e._origin.x + x(a) * i, P.t[P.i + 1] = e._origin.y + O(a) * i, P = P._next;
        }

        for (r = t < 0.5 ? 2 * t * t : (4 - 2 * t) * t - 1; d;) {
          p = (s = d.i) + (s === (o = u[d.j]).length - 4 ? 7 - o.length : 5), a = v(o[p] - o[s + 1], o[p - 1] - o[s]), g = O(a), f = x(a), l = o[s + 2], c = o[s + 3], i = d.l1s + r * d.l1c, o[s] = l - f * i, o[s + 1] = c - g * i, i = d.l2s + r * d.l2c, o[p - 1] = l + f * i, o[p] = c + g * i, d = d._next;
        }

        if (m._gsRawPath = u, e._apply) {
          for (n = "", h = 0; h < u.length; h++) {
            for (i = (o = u[h]).length, n += "M" + (o[0] * _ | 0) / _ + " " + (o[1] * _ | 0) / _ + " C", s = 2; s < i; s++) {
              n += (o[s] * _ | 0) / _ + " ";
            }
          }
...
var projects_wrapper = document.querySelector('.projects_wrapper');
var projects = document.querySelectorAll('.project_wrapper');
var vH = window.innerHeight;
var h_center = vH / 10;

function adjustProjects(project) {
  var projectBounds = project.getBoundingClientRect();
  var projectTop = projectBounds.top;
  var diff = Math.abs(projectTop - h_center);
  var percent = 100 * diff / vH;

  if (percent > 90) {
    percent = 90;
  }

  var div = project.querySelector('.project');
...
projects_wrapper.addEventListener('scroll', function (e) {
  projects.forEach(function (project) {
    adjustProjects(project);
  });
});
...
window.gsap = __webpack_require__(/*! ./gsap */ "./resources/js/gsap.js");

__webpack_require__(/*! ./morph */ "./resources/js/morph.js");
...
var video = document.querySelector("#bg_video video");
video.load();
var videoLoader = setInterval(function () {
...
var elements = ['ml16', 'ml12'];
elements.forEach(function (classes) {
  var textWrapper = document.querySelector('.' + classes);
...
setTimeout(function () {
  ...
  var description_content = document.querySelector('.description_content');
...
var socials = document.querySelectorAll('.social_item');
var i = 0;
...
var projects = document.querySelector('.projects_wrapper');
projects.animate([{
  opacity: 0
}, {
  opacity: 1
